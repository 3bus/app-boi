...
function OrderSection() {
  return (
    <div className={tw`flex flex-col  p-6 bg-white	 rounded-lg`}>
      ...
      <label htmlFor="dog-names">Choose a refreshment for when you leave the bus:</label>
      <select className={tw`bg-white font-bold py-2 px-4 rounded`} style={{ marginBottom: 4}} name="dog-names" id="dog-names">
        <option value="rigatoni">Coke Can (400 Bussin')</option>
        <option value="dave">Muffin (500 Bussin') </option>
        <option value="pumpernickel" selected>Sachet of Raro (100 Bussin')</option>
...
function VoteSection() {
  ...
  <div>
    <div className={tw`form-check`}>
      <input className={tw`form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer`} type="radio" name="flexRadioDefault" id="flexRadioDefault1" />
      <label className={tw`form-check-label inline-block text-gray-800`} htmlFor="flexRadioDefault1">
        Metal (1 Bussin')
      </label>
    </div>
    <div className={tw`form-check`}>
      ...
      <label className={tw`form-check-label inline-block text-gray-800`} htmlFor="flexRadioDefault2">
        Vaporwave (2 Bussin')
      </label>
    </div>
    <div className={tw`form-check`}>
      ...
      <label className={tw`form-check-label inline-block text-gray-800`} htmlFor="flexRadioDefault3">
        Showtunes (free)
      </label>
    </div>
  </div>
...
export const Bussin = () => {
  ...
  return (
    <Layout hasSearch={false}>
      ...
      <SectionContainer>
        <ProfileSection  pointCount={pointCount}
